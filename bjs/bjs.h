...
struct bjs_pool_t {
    ...
    int nnodes;    
    struct Xpnodeset *nodes;	/* array of nodes for this pool */
 ...
 */
extern void bjs_node_allocate(struct bjs_job_t *j, int node, int set_owner);
...
/* XCPU-specific functions */

#define DEFAULT_STATFS_ADDR "localhost!20003"
