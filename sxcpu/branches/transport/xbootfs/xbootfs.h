...
static int      crc_read(Spfilefid *fid, u64 offset, u32 count, u8 *data, Spreq *req);
...
static int      localfileread(Spfile *parent, char* filename, int r);
static File     *filealloc(Spfile *parent, char *name, int datasize, 
			   int datalen, char *data, u32 mtime, u32 crc);
//crc32 and crc32 were taken from: http://fxr.watson.org/fxr/source/libkern/crc32.c
static u32      crc32(const void *buf, size_t size);
